...
Moved to `SUBMISSION_CHECKLIST.md`, which is not hashed into the package digest: it is
meant to change as the release progresses, and a frozen digest must not cover it.
